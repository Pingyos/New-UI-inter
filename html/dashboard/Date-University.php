                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <div class="flex align-items-center list-user-action">
                                                        ...
                                                        <a class="btn btn-sm btn-icon btn-danger" data-toggle="tooltip" data-placement="top" title="" data-original-title="Delete" href="Date-University-Del.php?university_id=<?= $t1['university_id']; ?>">
                                                            <span class="btn-inner">
